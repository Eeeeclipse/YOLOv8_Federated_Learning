...
if __name__ == '__main__':
    ...
    for _ in range(num_comm):
        ...
        for index, dup_model in enumerate(models):
            dup_model.train(data=config_paths[index], epochs=num_local_step, batch=64, save=True, resume=True, iou=0.5, conf=0.001, plots=False, workers = 0, lr0 = lr, lrf = lr)
    ...
    torch.save(model,'FedAvg_final_model.pt')
